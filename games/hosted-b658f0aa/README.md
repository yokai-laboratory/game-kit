...
This folder is a game-kit game generated from your Metatron hosted bundle.
...
- Screens are different runtimes: window.tron there, React props here -- port src/screen.tsx by hand.
- Stakes: the kit's pot flow (stakeEth on room create + TRON charge intents) replaces the hosted stakeTusdCents manifest field.
